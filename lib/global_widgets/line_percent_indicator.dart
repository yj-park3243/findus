...
class LinearPercentIndicator extends StatefulWidget {
  ...
  ///commonWidget at the left of the Line
  final Widget? leading;

  ///commonWidget at the right of the Line
  final Widget? trailing;

  ///commonWidget inside the Line
  final Widget? center;
  ...
  ///alignment of the Row (leading-commonWidget-center-trailing)
  ...
  /// set false if you don't want to preserve the state of the commonWidget
  ...
  /// Display a commonWidget indicator at the end of the progress. It only works when `animation` is true
